...
""" NO NEED TO FEATURE SCALE FOR RANDOM FOREST: NOT EUCLIDEAN DISTANCE BASED (nicer for plotting though) """
...
# fit random forest to data, use entropy (creates homogeneous groups)
