...
""" NO NEED TO FEATURE SCALE FOR DECISION TREE: NOT EUCLIDEAN DISTANCE BASED (nicer for plotting though) """
...
# fit decision tree to data, use entropy (creates homogeneous groups)
